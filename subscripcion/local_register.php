    ...
    <div class="container">
        <div class="group">
            <form action="./lib/registro.php" method="POST">
                <h2><em>Registro o Asitencia</em></h2>
            ...
            ?>
                ...
                <center> <input class="form-btn" name="submit" type="submit" value="Registrar" /> <a href="./menu.php"
                        class="form-btn-back">Regresar al menu</a></center>
                </p>
            </form>
        </div>
    </div>
